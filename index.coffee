...
packageData.dependencies = [
  __dirname + "/libs/cltk/CLFramework.coffee",
  __dirname + "/libs/cltk/CLUtils.coffee",
  __dirname + "/libs/cltk/CLDynamicFileLoader.coffee",
  __dirname + "/libs/cltk/CLLIghtBox.coffee",
  __dirname + "/libs/cltk/CLShaderLoader.coffee",
  __dirname + "/libs/cltk/lightbox.css"
]
...
app.configure ->
	...
	app.get "/bootstrap.js", (req, res) -> 
		fs.readFile __dirname + "/app/script.coffee", 'utf-8', (err, data) ->
			if err 
				res.writeHead 404
				res.end "Problem!"
			else
